...
public class CRUService<TEntity, TId> : CRService<TEntity, TId>, ICService<TEntity, TId>, IRService<TEntity, TId>, IUService<TEntity, TId>, ICRService<TEntity, TId>, IRUService<TEntity, TId> where TEntity : class, IEntity<TId>
{
